...
namespace Lab_4_6_Array_To_Do_List
{
    class Program
    {
        ...
        Requirements:
        The do-to list planner with cycle through each day of the week, pausing to let the user
        type in a task. The planner will save each task the user types in, and then display all of
        the days and tasks together. See the screenshot below for an example of the screen
        output.  
